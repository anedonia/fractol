...
/*   Updated: 2022/03/25 17:58:49 by ldevy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_printf("fractol \"mandelbrot\" or \"julia\" or \"burningship\" are possible arguments\n");
	ft_printf("if julia set is selected you may input two more args ex : \"12\" \"58\" (numbers)\n");
	exit(0);
}
